...
public class TripSampleProcessorJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        messageStream.rebalance().map(new MapFunction<String, TripSample>() {
            ...
            public TripSample map(String value) throws Exception {
                ...
                new TripSampleGeomesaSink(
                        parameterTool.get("zookeepers"),
                        parameterTool.get("instanceId"),
                        parameterTool.get("user"),
                        parameterTool.get("password"),
                        parameterTool.get("tableName"),
                        parameterTool.get("simpleFeatureTypeName", "FlakAcceleration")
                )
        );
